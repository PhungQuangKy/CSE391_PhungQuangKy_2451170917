...
Dưới đây là toàn bộ mã nguồn file `product_manager.js` hoàn chỉnh, bao gồm mảng dữ liệu ban đầu, định nghĩa đầy đủ 8 hàm xử lý theo đúng yêu cầu (sử dụng các phương thức `map`, `filter`, `reduce`, `sort`, `find`) và phần kịch bản chạy thử nghiệm ở cuối.
...
const products = [
  ...
  { id: 7, name: "Galaxy Buds", price: 34990000, category: "accessory", stock: 100, rating: 4.1 },
  { id: 8, name: "Xiaomi Pad 6", price: 7990000, category: "tablet", stock: 25, rating: 4.2 },
  { id: 9, name: "Pixel 9", price: 19900000, category: "phone", stock: 12, rating: 4.6 },
...
// 3. Sắp xếp theo giá (tăng/giảm) - Sử dụng toSorted() để không mutate mảng gốc
function sortByPrice(products, order = "asc") {
  return products.toSorted((a, b) => order === "asc" ? a.price - b.price : b.price - a.price);
}
